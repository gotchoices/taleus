...
The `LiftLading` view in `packages/taleus-core/schema/draft1.qsql` computes advertised lift capacity with
...
- A signpost `NOTE:` comment sits at the `LiftLading` definition in `packages/taleus-core/schema/draft1.qsql`.
