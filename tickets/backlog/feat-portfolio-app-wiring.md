...
files: docs/architecture.md, packages/taleus-core/schema/portfolio.qsql
----
...
- **First-launch create.** On a party's first bring-up, form the single-party portfolio strand (founder/solo bootstrap, `publishStrand`), apply `packages/taleus-core/schema/portfolio.qsql`, and write the `PortfolioCore` marker row with the party's own Sid.
