...
Group 2 — the rest of the tally lifecycle. Same cast; 05 and 07 follow Jan and Sam a year on, 06
follows Jan once he has enough tallies to lose track of them.

| # | Story | State |
|---|-------|-------|
| 05 | [Close a tally](05-close-a-tally.md) | drafted |
| 06 | [Find a tally](06-find-a-tally.md) | drafted |
| 07 | [Review the agreement](07-review-the-agreement.md) | drafted |
...
Known open point inside this group: whether a declined invitation is visible to the inviter
(story 02, alternative B) — being settled in the `feat-offer-lifecycle` ticket.

## Not yet written

| # | Story | State |
|---|-------|-------|
| 10 | [First run](10-first-run.md) | stub |
| 11 | [My profile and what I disclose](11-my-profile-and-disclosure.md) | stub |
| 12 | [Keys and backup](12-keys-and-backup.md) | stub |
...
## Suggested order after group 2

- **Group 3 — getting started**: 10, 11, 12. Everything a person meets before their first tally.
