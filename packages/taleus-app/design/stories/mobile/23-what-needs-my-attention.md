...
MyCHIPs: Activity screen and PendingChits; the schema flags exactly which states require action.

## Open
Whether items waiting on the other party surface here at all.
