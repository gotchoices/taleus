...
15. [My position](40-my-position.md) — owed, owing, and an estimate (40)
16. [What units are worth to me](41-my-exchange-rates.md) — pricing a unit, and what that makes you (41)
17. [Settings](42-settings.md) — language, unit, appearance, and which follow you (42)
18. [My profile and what I disclose](11-my-profile-and-disclosure.md) — who knows what, and why (11)
...
One doc per story, for every story a coded screen serves. Twenty-one screens are built — `Welcome`,
...
`Settings`, `Profile`, `DisclosureView`, `TallyTerms`, `EntryDetail`, `ExchangeRates`, `StandingInvitation` — covering
